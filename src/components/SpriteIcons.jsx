const SpriteIcons = ({ name, className = "w-5 h-5", color = "currentColor" }) => {
  const icons = {
    home: (
    ...
    offers: (
      <svg className={className} fill={color} viewBox="0 0 24 24">
        <path d="M7 4V2c0-1.1.9-2 2-2h6c1.1 0 2 .9 2 2v2h3c.6 0 1 .4 1 1s-.4 1-1 1h-1v12c0 1.1-.9 2-2 2H7c-1.1 0-2-.9-2-2V6H4c-.6 0-1-.4-1-1s.4-1 1-1h3zm2-2v2h6V2H9zm-1 4v10h8V6H8z"/>
      </svg>
    ),
    about: (
      <svg className={className} fill={color} viewBox="0 0 24 24">
...
store: (
  <svg className={className} fill={color} viewBox="0 0 24 24">
    ...
    orders: (
      <svg className={className} fill={color} viewBox="0 0 24 24">
        <path d="M7 4V2c0-1.1.9-2 2-2h6c1.1 0 2 .9 2 2v2h3c.6 0 1 .4 1 1s-.4 1-1 1h-1v12c0 1.1-.9 2-2 2H7c-1.1 0-2-.9-2-2V6H4c-.6 0-1-.4-1-1s.4-1 1-1h3zm2-2v2h6V2H9z"/>
      </svg>
    ),
    inventory: (
      <svg className={className} fill={color} viewBox="0 0 24 24">
